...
SRC-DATA	:= ./data
DATA		:= $(SRC-DATA)/tegra210-p3448-common-sdmmc3.dtbo $(SRC-DATA)/tegra210-porg-p3448-emc-a00.dtbo $(SRC-DATA)/u-boot-preboot.scr
build-data: $(DATA)
...
$(SRC-DATA)/tegra210-porg-p3448-emc-a00.dtbo: $(SRC-DATA)/tegra210-porg-p3448-emc-a00.dts Linux_for_Tegra/source/kernel/hardware/nvidia/soc/tegra/kernel-include
	cpp -nostdinc -undef -x assembler-with-cpp -E -I "Linux_for_Tegra/source/kernel/hardware/nvidia/soc/tegra/kernel-include" $(SRC-DATA)/tegra210-porg-p3448-emc-a00.dts $(SRC-DATA)/tegra210-porg-p3448-emc-a00.dts.tmp
	dtc -O dtb -o "$@" -@ $(SRC-DATA)/tegra210-porg-p3448-emc-a00.dts.tmp
	rm $(SRC-DATA)/tegra210-porg-p3448-emc-a00.dts.tmp
...
flash-data: $(DATA) $(SRC-DATA)/nv_boot_control.conf $(SRC-DATA)/nv_boot_control.service
	...
	sudo cp "$(SRC-DATA)/tegra210-porg-p3448-emc-a00.dtbo" "$(MNTDIR)/boot/tegra210-porg-p3448-emc-a00.dtbo"
